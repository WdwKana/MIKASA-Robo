...
from baselines.ppo.modules.frozen_clip import FrozenDualClip as FrozenDualDinoV2  # alias to keep diff small
...
HEAD_PATH = ROOT / "analysis/ebm/path_a_head_v3_clip.pt"
OUT_VIS   = ROOT / "analysis/ebm/path_a_vis_v3_clip"
