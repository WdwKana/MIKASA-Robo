...
from baselines.ppo.modules.ebm_srb_tr_cres_writeablate import (
    EBMSRBTRCRESWriteAblateMemoryModule as EBMMemoryModule,
)
...
class Args:
    ...
    write_rule: str = ""
    """REQUIRED: 'random' (K random tokens, constant priority, dedup kept) or
    'fifo' (random + dedup off = fully content-blind). The 'surprise' rule is
    the main method — run ppo_memtasks_ebm_srb_tr_cres_caps.py for it."""
